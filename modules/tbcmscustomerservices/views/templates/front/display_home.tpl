...
{if $dis_arr_result.status}
    <div class="tbcmscustomer-services container-fluid bottom-to-top hb-animate-element">
        <div class="tbcustomer-services container">
            <div class="tbservice-allservice-main clearfix">
                {* <div class="tbservice-image-wrapper col-xl-6 col-lg-5 col-md-12 col-sm-12 col-xs-12">
                        <img src="{$dis_arr_result['path']}{$main_heading.data.image}" alt="{$main_heading.data.title}">
                </div> *}
                <div class="tbservice-inner row">
                ...
                <!-- <div class='tbcms-service-pagination-wrapper'>
                    <div class="tbcms-service-pagination">
                        <div class="tbcms-service-next-pre-btn">
                            <div class="tbservice-slider-prev tbcmsprev-btn"><i class='material-icons'>&#xe314;</i></div>
                            <div class="tbservice-slider-next tbcmsnext-btn"><i class='material-icons'>&#xe315;</i></div>
                        </div>
                    </div>
                </div> -->
            </div>
