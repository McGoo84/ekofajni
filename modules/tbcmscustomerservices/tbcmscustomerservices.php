...
class TbcmsCustomerServices extends Module
{
    ...
    public function crateVariable()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $result['TBCMSCUSTOMERSERVICES_SERVICES_1_CAPTION'][$lang['id_lang']] = 'Fast delivery';
            ...
            $result['TBCMSCUSTOMERSERVICES_SERVICES_2_CAPTION'][$lang['id_lang']] = 'Secure Payment';
            ...
            $result['TBCMSCUSTOMERSERVICES_SERVICES_3_CAPTION'][$lang['id_lang']] = 'Member Discounts';
            ...
            $result['TBCMSCUSTOMERSERVICES_SERVICES_4_CAPTION'][$lang['id_lang']] = 'Easy Return';
