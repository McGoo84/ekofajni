    	...
    	<div class="tbbanner-wrapper tbone-banner-wrapper-info">
        	<div class="tbbanner1 col-md-6 col-sm-6 col-xs-12">
                <div class="tbofferbanner-two-inner">
                    <a href="{$data['TBCMSTWOOFFERBANNER_LINK']}" class="tbbanner-hover-wrapper" {* title="{$data['TBCMSTWOOFFERBANNER_CAPTION'][$language_id]}" *}>
            ...
            <div class="tbbanner2 col-md-6 col-sm-6 col-xs-12">
                <div class="tbofferbanner-two-inner">
                    <a href="{$data['TBCMSTWOOFFERBANNER_LINK_2']}" class="tbbanner-hover-wrapper" {* title="{$data['TBCMSTWOOFFERBANNER_CAPTION_2'][$language_id]}" *}>
