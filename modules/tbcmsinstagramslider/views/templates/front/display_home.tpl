...
<div class=" tbcmsinstagram-slider col-xl-3 col-lg-3 col-md-12 col-xs-12 col-sm-12">
	<div class='tbinstagram-slider'>
		

		{if !empty(Configuration::get('CS_TITLE', $language.id))}
		<div class="tbinstagram-slider-title-wrapper">
			<div class="tbinstagram-slider-title-inner">
				<div class="tbinstagram-slider-title-outer tbfooter-title-wrapper collapsed" data-target="#tbinstagram-slider-inner" data-toggle="collapse">
					<span class="tbinstagram-title tbfooter-title">{Configuration::get('CS_TITLE', $language.id)}</span>
		...
		<div id="tbinstagram-slider-inner" class="collapse">
