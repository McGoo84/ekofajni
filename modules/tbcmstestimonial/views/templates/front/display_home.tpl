...
{if $dis_arr_result['status']}
    <div class='container-fluid tbcmstestimonial tbcms-all-testimonial'>
        <div class='tbtestimonial'>
            ...
            <div class='tbcmstestimonial-main-title-wrapper container'>
                {include file='_partials/tbcms-main-title.tpl' main_heading=$main_heading path=$dis_arr_result['path']}
            </div>


            <div class="tbtestimonial-slider-inner container">
                    ...
                    <div class="item tbtestimonial-wrapper-info">
                        <div class="tbtestimonial-inner-content-box">
                            <div class="tbtestimonial-img-block">
                                <img src='{$dis_arr_result["path"]}{$data["image"]}' style='width:110px' />
                            </div>
