...
class AdminContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'mcgoo_pr1', 'user' => 'mcgoo_pr1', 'password' => 'V)W8Zz@54AcQ)Lz4SS(88,)6', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.0999999999999996, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setProxyDir('/home/mcgoo/domains/ekofajni.pl/public_html/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_8e58df9cfb290af88bc6a6e81c9776e239303fab73caf99a938a843a812da49c');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/home/mcgoo/domains/ekofajni.pl/public_html/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/home/mcgoo/domains/ekofajni.pl/public_html/var/cache/prod//localization'))) && false ?: '_'});
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/home/mcgoo/domains/ekofajni.pl/public_html/app/',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/home/mcgoo/domains/ekofajni.pl/public_html/var/cache/prod/',
            'kernel.active_modules' => [
                ...
                64 => 'ps_productinfo',
                65 => 'ps_supplierlist',
                66 => 'tbcmsbestsellerproducts',
                67 => 'tbcmsblog',
                68 => 'tbcmsblogdisplayposts',
                69 => 'tbcmsbrandlist',
                70 => 'tbcmscookiesnotice',
                71 => 'tbcmscustomsetting',
                72 => 'tbcmsfeaturedproducts',
                73 => 'tbcmsfootercategory',
                74 => 'tbcmsinfinitescroll',
                75 => 'tbcmsnewproducts',
                76 => 'tbcmsnewsletterpopup',
                77 => 'tbcmspaymenticon',
                78 => 'tbcmsproductcomments',
                79 => 'tbcmsproductcompare',
                80 => 'tbcmssearch',
                81 => 'tbcmsrightsideofferbanner',
                82 => 'tbcmssingleblock',
                83 => 'tbcmsslider',
                84 => 'tbcmsspecialproducts',
                85 => 'tbcmsstockinfo',
                86 => 'tbcmstabproducts',
                87 => 'tbcmstestimonial',
                88 => 'tbcmsthemeoptions',
                89 => 'tbcmswishlist',
                90 => 'tbcmstwoofferbanner',
                91 => 'tbcmscategoryslider',
                92 => 'tbcmscustomerservices',
                93 => 'tbcmsfooterlogo',
                94 => 'tbcmsinstagramslider',
            ],
            'ps_cache_dir' => '/home/mcgoo/domains/ekofajni.pl/public_html/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/home/mcgoo/domains/ekofajni.pl/public_html/var/cache/prod//doctrine/orm/Proxies',
